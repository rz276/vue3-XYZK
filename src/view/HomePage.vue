      ...
      <div class="row bigData-container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
          <h2 class="bigData-title">
            湘驿智库
            <small>/ Hunan Postal Think Tank</small>
          </h2>
          <p>
            全省四库资源线上管理平台通过PC端管理全省邮政系统的培训资源。支持资源分类存储、智能检索、动态更新和共享应用等功能，打破地域与单位限制，实现资源高效共享；支持平台资源关联，实现师资画像、智能推课、资源审核、评价与考核等功能，提升师资管理科学性与规范性；支持数据统计、权限分级管控，依据用户角色分级、实行管理控制、操作审计和业绩评估预警，提升平台管理效能。
          </p>
...
const swiperList = [
  {
    img: banner1,
    title: '师资库',
    content: '师资档案管理、授课管理、多维度评估、智能画像、双模式派课机制、授课可视化数据统计、智能预警'
  },
  {
    img: banner2,
    title: '课件库',
    content: '课件信息管理、课件自动编号、上传与存储、分类标签筛选定位、课件审核、课件评分、下载与使用日志统计'
  },
  {
    img: banner1,
    title: '案例库',
    content: '案例收集与整理、智能标签分类、案例审核与发布、案例展示与分享、案例讨论与交流'
  },
  {
    img: banner2,
    title: '试题库',
    content: '试题录入与编辑、分类与标签管理、语义相似度检测、试题难易度管理、试题组卷与发布、考试结果统计与分析'
  }
]
